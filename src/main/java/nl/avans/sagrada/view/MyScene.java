...
//            }
//        }
        patternCardView.setEyes(5, 0, 0);
        patternCardView.addEyes(0, 0);
        patternCardView.setEyes(2, 0, 1);
        patternCardView.addEyes(0, 1);
        patternCardView.setEyes(3, 0, 2);
        patternCardView.addEyes(0, 2);
        patternCardView.yolo();
