...
public class AccountController {
	...
	/**
	 * Registers a user via username and password, and checks for certain
	 * requirements linked to the username and password.
	 * 
	 * @param username
	 *            String
	 * @param password
	...
	/**
	 * Shows the register view, allowing the register screen to be displayed as
	 * current screen.
	 */
