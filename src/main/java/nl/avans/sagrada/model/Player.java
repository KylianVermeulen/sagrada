...
public class Player {
	 ...
	 *
	 * @param playerStatus
	 *            Must be an existing status in the database.
	 */
	 ...
	 *
	 * @param seqnr
	 *            Must be a valid turn and unique in a game.
	 */
	 ...
	 *            There can only be one current player in game.
	 */
	 ...
	 *
	 * @param score
	 *            Must be greater or equal than -20.
	 */
	 ...
	 *
	 * @param account
	 *            Must be a existing account in the database.
	 */
	 ...
	 *
	 * @param game
	 *            Must be a existing game in the database.
	 */
	...
	/**
	 * @param patterncard
	 *            The patterncard of this player.
	 */
	 ...
	 *            The optional pattern cards of this player to the database.
	 */
	...
	/**
	 * @param favorTokens
	 *            The favor tokens of this player.
	 */
